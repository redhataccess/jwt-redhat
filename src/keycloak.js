                    ...
                    return {
                        ...
                        redirectUri: function(options, encodeHash) {
                            ...
                            if (options && options.redirectUri) {
                                requestedRedirectUri = options.redirectUri;
                            } else if (kc.redirectUri) {
                                requestedRedirectUri = kc.redirectUri;
                            } else {
                                requestedRedirectUri = location.href;
                            }
    
                            baseUri = requestedRedirectUri.slice(0, requestedRedirectUri.indexOf('#'));
                            hashValue = requestedRedirectUri.slice(baseUri.length + 1);
